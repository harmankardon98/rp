        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-0">
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" action="proses_lupa_password.php" method="post">
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="id user" type="id_user" name="id_user" required oninvalid="this.setCustomValidity('Kosong! Masukkan ID Dengan benar')" required="">
                  </div>
                </div>
              ...
              <div class="text-center">
                <a href="login.php"><button type="button" class="btn btn-primary my-4" style="margin-top:-20px !important;width: 100%;">Back</button> </a>
              </div>
            </div>
          </div>
