...
$id_jadwal = $_GET['id_jadwal'];
	$query = mysql_query("SELECT * FROM jadwal WHERE id_jadwal='$id_jadwal'")or die(mysqli_error());
          ...
          <div class="card bg-secondary shadow border-0">
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4">
                <h3>Edit Jadwal Student</h3>
              </div>
              <form name="form" action="proses_edit_jadwal_student.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                  ...
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" name="tutor" placeholder="tutor" type="text" required="" value="<?php echo $rows['tutor'] ?>">
                  </div>
                </div>
  ...
  <option value="18.30 - 20.00">18.30 - 20.00</option>
        ...
        <option>-pilih ulang hari-</option>>
                  ...
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" name="id_student" placeholder="id student" type="text" required="" value="<?php echo $rows['id_student'] ?>">
                  </div>
                </div>
