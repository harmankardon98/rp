          ...
          <div class="card bg-secondary shadow border-0">
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4">
                <h3>Register Bio Admin</h3>
              </div>
              <form role="form" action="proses_register_admin.php" method="post" enctype="multipart/form-data">
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="ni ni-email-83"></i></span>
                    </div>
                    <input class="form-control" name="id_admin" placeholder="ID" type="text" required="">
                  </div>
                </div>
                ...
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" name="nama_admin" placeholder="Nama username" type="text" required="">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" name="alm_admin" placeholder="Alamat" type="text" required="">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" name="no_tlp" placeholder="No Telp" type="text" required="">
                  </div>
                </div>
                  ...
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" name="school" placeholder="sekolah" type="text" required="">
                  </div>
                </div>
                  ...
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" name="kota" placeholder="kota" type="text" required="">
                  </div>
                </div>
                  ...
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" name="about" placeholder="tentang" type="text" required="">
                  </div>
                </div>
