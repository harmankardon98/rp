          ...
          <div class="card bg-secondary shadow border-0">
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" action="proses_login.php" method="post">
                ...
                <input type="hidden" name="act" value="login-user">
                <div class="text-center">
                  <button type="submit" class="btn btn-primary my-4" style="width: 100%;">Login</button>
                </div>
              </form>
              <div class="text-center">
                <a href="index.php"><button type="button" class="btn btn-primary my-4" style="margin-top:-20px !important;width: 100%;">Home</button> </a>
              </div>
            </div>
          </div>
          <div class="row mt-3">
            <div class="col-6">
              <a href="lupa_password.php" class="text-light"><small>Forgot password?</small></a>
            </div>
